...
var initPerfectScrollbar = function initPerfectScrollbar() {
  var scrollbarWrappers = document.querySelectorAll('.perferct-scrollbar');
  scrollbarWrappers.forEach(function (wrapper) {
    new _perfectScrollbar["default"](wrapper, {
      wheelSpeed: 0.5,
...
var changeStyle = function changeStyle() {
  ...
  $('.brand-color > a').on('click', function () {
    var temp = $(this).attr('data-value'); // $('.header-color > a').removeClass('active');
    ...
    if (temp == 'bg-default') {
      ...
      $('.m-header').removeClassPrefix('bg-');
      $('.m-header > .b-brand > .logo-lg').attr('src', '/public/images/logo.svg');
  ...
  $('#cust-sidebar').on('change', function () {
    if ($(this).is(':checked')) {
      ...
      $('.pc-horizontal .topbar').addClass('light-sidebar'); // $('.m-header > .b-brand > .logo-lg').attr('src', 'assets/images/logo-dark.svg');
    } else {
      $('.pc-sidebar').removeClass('light-sidebar');
      $('.pc-horizontal .topbar').removeClass('light-sidebar'); // $('.m-header > .b-brand > .logo-lg').attr('src', 'assets/images/logo.svg');
    }
  }); // header option
  ...
  $('#cust-sidebrand').on('change', function () {
    if ($(this).is(':checked')) {
      ...
      $('.m-header > .b-brand > .logo-lg').attr('src', '/public/images/logo-dark.svg');
    } else {
      $('.m-header').removeClassPrefix('bg-');
...
},{"@babel/polyfill":2,"perfect-scrollbar":308}],2:[function(require,module,exports){
"use strict";
